...
if text == "تفعيل شعر" and Manager(msg) and SourceCh(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1,"*⌔︰تم تفعيل امر شعر بنجاح*",'md')
DevHmD:del(DevTwix..'HmD:Poetry:HmD'..msg.chat_id_) 
end
if text == "تعطيل شعر" and Manager(msg) and SourceCh(msg) then
...
------------------------------------------------------------------------------------------------------------
if SecondSudo(msg) then
if text == "تحديث تويكس" and SourceCh(msg) or text == "تحديث سورس تويكس" and SourceCh(msg) or text == "× تحديث السورس ×" and SourceCh(msg) then 
...
if text == 'تحديث ملفات البوت' and SourceCh(msg) or text == 'تحديث البوت' and SourceCh(msg) or text == '× تحديث الملفات ×' and SourceCh(msg) then  
dofile('DevTwix.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n        ( تم تحديث ملفات البوت )        \n\27[0;34;49m\n") 
