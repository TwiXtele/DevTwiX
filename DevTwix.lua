...
local url,res = https.request('https://anashtick.ml/DevTwix/ChCheck.php?id='..msg.sender_user_id_)
...
--------------------------------------------(Admin-Source)-----------------------------------------
if DataText and DataText:match('/deladminList:(.*)') then
local HmD = DataText:match('/deladminList:(.*)')
if tonumber(HmD) == tonumber(data.sender_user_id_) then
DevHmD:del(DevTwix..'HmD:Add:GpRed'..data.sender_user_id_..data.chat_id_)
DevHmD:del(DevTwix..'HmD:Admins:'..data.chat_id_)
EditMsg(Chat_Id2, Msg_Id2, "*⌔︰تم مسح قائمة الادمنية*") 
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✫ عذرا الامر ليس لك .")..'&show_alert=true')
end
end
...
if text == "تفعيل بابو" or text == "تفعيل البايو" and Manager(msg) and ChCheck(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1,"*⌔︰تم تفعيل بايو بنجاح*",'md')
DevHmD:del(DevTwix..'HmD:Biio:HmD'..msg.chat_id_) 
end
if text == "تعطيل بايو" or text == "تعطيل البايو" and Manager(msg) and ChCheck(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1,"*⌔︰تم تعطيل بايو بنجاح*",'md')
DevHmD:set(DevTwix..'HmD:Biio:HmD'..msg.chat_id_,true)  
end
if text == 'نبذتي' or text == 'بايو' or text == '× نبذتي ×' and not DevHmD:get(DevTwix..'HmD:Biio:HmD'..msg.chat_id_) and ChCheck(msg) then
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="≺• اخفاء الكليشة •≻",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="{ مسح الرد }",callback_data="/DelRedList:"..msg.sender_user_id_},{text="{ الغاء الأمر }",callback_data="/RedList:"..msg.sender_user_id_}},{{text="≺• اخفاء الكليشة •≻",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
---------------------------------------------------------------------------------------------------------
if text == "التحديثات" and SecondSudo(msg) and ChCheck(msg) or text == "تحديث" and ChCheck(msg) or text == "تحديث السورس" and ChCheck(msg) or text == "تحديث الملفات" and ChCheck(msg) then
local Help = DevHmD:get(DevTwix..'HmD:Help')
if not SecondSudo(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1, '*⌔︰الامر للمطورين فقط ..*', 'md')
return false
end
local Text = [[*⌔︰اليك قائمة ازرار التحديثات 
⌔︰اختر الان التحديث المطلوب لتنفيذه 
⎯ ⎯ ⎯ ⎯ ⎯ *]] 
keyboard = {} 
keyboard.inline_keyboard = {{{text="{ تحديث السورس }",callback_data="/restartList:"..msg.sender_user_id_},{text="{ تحديث الملفات }",callback_data="/restartfielList:"..msg.sender_user_id_}},{{text="≺• اخفاء الكليشة •≻",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Help or Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------
if text == "مبرمج السورس" and ChCheck(msg) or text == "مطور السورس" and ChCheck(msg) or text == "وين المبرمج" and ChCheck(msg) or text == "المبرمج" and ChCheck(msg) or text == "× مطور السورس ×" and ChCheck(msg) then 
