------------------------------------------------
-- This Source Was Developed By (HmD) @VLVLVI.--
--   This Is The Source Channel @DQQQP .   --
--                - DevTwix -                 --
--        -- https://t.me/DQQQP --         --
------------------------------------------------ 
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,332581832,767010534,531567606}
DevTwix = Config.DevTwix
TokenBot = Config.TokenBot
NameBot = (DevHmD:get(DevTwix..'HmD:NameBot') or 'بروك')
--     Source DevTwix     --
...
local UserName = (dp.username_ or "DQQQP")
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="᥀ 𝗗𝗮𝘃𝗶𝗱 : 𝗧𝗲𝗮𝗠 .",url="t.me/DQQQP"}}} 
...
✫∫ م6 ← اوامر الاعضاء
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
✫∫ [Source Channel](https://t.me/DQQQP)
]] 
keyboard = {} 
...
if text and text:match('^'..(DevHmD:get(DevTwix..'HmD:NameBot') or "بروك")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevHmD:get(DevTwix..'HmD:NameBot') or "بروك")..' ','')
end
...
Dev_HmD(msg.chat_id_, msg.id_, 1, '✫∫ العضو ← ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'DQQQP')..')'..' ❩\n✫∫ تم رفعه ❨ '..DEV_HmD..' ❩ بنجاح', 1, 'md')
...
if mrHmD == "مميز" and VipMem(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1, '✫∫ العضو ← ❨ ['..result.title_..'](t.me/'..(text1[3] or 'DQQQP')..')'..' ❩\n✫∫ تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي المطور \n✫∫ اليك الازرار الخاصه بتعديل وتغيير كلايش سورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تغير معلومات الترحيب'},
...
if text == '← السورس ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي المطور \n✫∫ اليك الازرار الخاصه بتحديث  سورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'← تحديث السورس ᥀','← تحديث ᥀'},
{'← السيرفر ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي المطور \n✫∫ اليك الازرار الخاصه ب أحصائيات  سورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'←  الاحصائيات ᥀'},
{'← المشتركين ᥀','← المجموعات ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي المطور \n✫∫ اليك الازرار الخاصه ب المطورين لسورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي المطور \n✫∫ اليك الازرار الخاصه ب التفعيل والتعطيل لسورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي المطور \n✫∫ اليك الازرار الخاصه بالاذاعه لسورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'← اذاعه بالتثبيت ᥀'},
{'← اذاعه خاص ᥀','← اذاعه عام ᥀'},
...
if text == '← العام ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي المطور \n✫∫ اليك الازرار الخاصه بالعام لسورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي المطور \n✫∫ اليك الازرار الخاصه بردود الخاص لسورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي المطور \n✫∫ اليك الازرار الخاصه بالاشتراك الاجباري لسورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي \n✫∫ اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي \n✫∫ اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'← غنيلي ᥀','← اغنيه ᥀'},
{'← ميمز ᥀','← ريمكس ᥀'},
{'← صوره ᥀','← متحركه ᥀'},
...
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي \n✫∫ اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي \n✫∫ اليك الازرار الخاصه بأوامر النسب الخاصه بسورس بروك فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '← العاب ᥀' then 
local Sudo_Welcome = '✫∫ اهلا بك مجددا عزيزي \n✫∫ اليك الازرار الخاصه بألعاب سورس بروك فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
local inline = {
{{text="᥀ المطور .",url="t.me/"..(dp.username_ or "DQQQP")}},
{{text="᥀ السورس .",url="https://t.me/DQQQP"},{text="᥀ لتنصيب بوت .",url="https://t.me/VLVLVI"}},{{text="᥀ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
...
Dev_HmD(msg.sender_user_id_, msg.id_, 1, '✫∫ تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "DQQQP")..')', 1, 'md') 
...
if text == "الحمايه" or text == "← الحمايه ᥀" then  Dev_HmD(msg.chat_id_, msg.id_, 1, '✫∫  اضف البوت في المجموعه ثم قم برفعه مشرف وارسل تفعيل \n✫∫  وتمتع بخدمات غير موجوده في باقي البوتات ', 1, 'md') end
...
if text == "اهمس" and ChCheck(msg) or text == "← بوت الهمسه ᥀" and ChCheck(msg) or text == "بوت الهمسه" and ChCheck(msg) or text == "همسه" and ChCheck(msg) or text == "اريد بوت الهمسه" and ChCheck(msg) or text == "دزلي بوت الهمسه" and ChCheck(msg) or text == "دزولي بوت الهمسه" and ChCheck(msg) then  Dev_HmD(msg.chat_id_, msg.id_, 1, '✫∫ @HMSEBOT\n✫∫ @nnbbot\n✫∫ @ocBot\n✫∫ @hebot ', 1, 'md') end
...
if text == "← بوت الزخرفه ᥀" and ChCheck(msg) or text == "بوت الزخرفه" and ChCheck(msg) or text == "بوت زخرفه" and ChCheck(msg) then local inline = {{{text="اضغط هنا",url="https://t.me/DevTwixTeAm"}}} SendInline(msg.chat_id_,'*✫∫ اضغط للحصول على بوت الزخرفه*',nil,inline) return false end
...
local DevTwixTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or DQQQP}}}
...
{{text = '᥀ DevTwix Team .', url="t.me/DQQQP"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@DQQQP]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@DQQQP]'))
Dev_HmD(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source DevTwix     --
--        Contact         --
...
local BotName = (DevHmD:get(DevTwix.."HmD:NameBot") or 'بروك')
...
if text and text == (DevHmD:get(DevTwix..'HmD:NameBot') or 'بروك') then 
NameBot = (DevHmD:get(DevTwix..'HmD:NameBot') or 'بروك')
...
Text = [[
Welcome To Source
✫∫ [DevTwix Team](https://t.me/DQQQP)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/DQQQP"}},
{{text = '᥀ Developer',url="t.me/VLVLVI"},{text = '᥀ Tws DevTwix',url="https://t.me/W555Bot"}},{{text= '᥀ Support Source .',url="https://t.me/joinchat/L980Ig8wQnAyN2Vi"}}
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X6UX6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/DQQQP' end
...
ConstructorHmD = "["..HmD.first_name_.."](T.me/"..(HmD.username_ or "DQQQP")..")"
else 
...
Dev_HmD(msg.chat_id_, msg.id_, 1, '✫∫ جاري تحديث سورس بروك', 1, 'md') 
os.execute('rm -rf DevTwix.lua') 
os.execute('wget https://raw.githubusercontent.com/THE-DevTwix/DevTwix/main/DevTwix.lua') 
dofile('DevTwix.lua') 
...
DevHmD:set(DevTwix..'HmD:NameBot',(DevHmD:get(DevTwix..'Name:Bot') or 'بروك'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
Text = [[
✫∫ [قناة السورس](https://t.me/DQQQP)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ قناة السورس',url="t.me/DQQQP"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DQQQP&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source DevTwix     --
